...
class CountriesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $newCountry->tel = "355";
        $newCountry->phone_length = 9; // عدد الخانات المقبولة بدون كود الدولة
        $newCountry->save();
