                ...
                <div class="container d-flex align-items-center">
                    <a class="logo me-auto" href="{{ Helper::homeURL() }}">
                        @if(Helper::GeneralSiteSettings("style_logo_" . @Helper::currentLanguage()->code) !="")
                            <a style="display: flex; align-items: center; padding-top: 10px">
                                <img style="width: 50px;padding: 0px; alt:"{{ Helper::GeneralSiteSettings('site_title_' . @Helper::currentLanguage()->code) }}"
                                ...
                                <span class="hidden-folded inline" style="font-size:small; margin-left: 10px;">{{ Helper::GeneralSiteSettings('site_title_' . @Helper::currentLanguage()->code) }}</span>
                            </a>
                        @else
...
<style>
                    ...
                    <li {{ (Route::currentRouteName()=="Certificate") ? 'class=active' : '' }}>
                        <a href="{{ route('certificate.index') }}">
                            ...
                            <span class="nav-text">{{ __('backend.Certificates') }}</span>
                        </a>
                    </li>
