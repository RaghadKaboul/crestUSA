        ...
        <div class="row-col">
                ...
                <div class="p-y">
                    <div class="nav-active-border left b-primary">
                        <ul class="nav nav-sm">
                            ...
                            <li class="nav-item">
                                <a class="nav-link block {{ ( Session::get('active_tab') == 'otherPagesTab' ) ? 'active' : '' }}"
                                   href="#"
                                   data-toggle="tab" data-target="#tab-16"
                                   onclick="clicked_tab('otherPagesTab')">
                                    &nbsp; {!!  __('backend.otherPages') !!}
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link block {{  ( Session::get('active_tab') == 'registrationSettingsTab') ? 'active' : '' }}"
                                   ...
                                   onclick="clicked_tab('registrationSettingsTab')">
                                    &nbsp; {!!  __('backend.registrationSettings') !!}
                              </a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="col-sm-7 col-lg-10 light lt">
                ...
                <div class="tab-content pos-rlt">
                    ...
                    @include('dashboard.system_settings.otherPages')
