...
<style>
    ...
    .footer-logo img {
        ...
        max-height: 300px; /* تحديد الحد الأقصى للارتفاع */
        width: auto; /* الحفاظ على نسبة العرض والارتفاع */
        height: auto;
        object-fit: contain; /* لضمان تناسب الصورة داخل الفوتر */
    }
                ...
                <div class="footer-logo">
                    <a href="#">
                        <img src="{{ URL::to('uploads/settings/'.Helper::GeneralSiteSettings('style_logo_' . @Helper::currentLanguage()->code)) }}"
                             alt="{{ Helper::GeneralSiteSettings('site_title_' . @Helper::currentLanguage()->code) }}"
