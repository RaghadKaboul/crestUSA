...
?>
<?php
//$lang=new \App\Http\Controllers\HomeController();
//$lang->set_language();
...
@if($home_page_id >0)
    ...
    @if(!empty($HomePage))
        @if(@$HomePage->$details_var !="")
            <section class="content-row-no-bg home-welcome " style=" padding: 10%;  margin-bottom:30px">
                <div class="section-title">
                    <h2>{{__('frontend.welcom')}}</h2>
                </div>
                <div class="container" style="padding: 10px; ">
                    <div class="row about-div section-bg"  style="padding: 10px">
                        <div class="col-lg-6 col-md-6 d-flex align-items-stretch mb-3" style="padding: 10px">
                            <img src="{{ url('uploads/topics/'. $HomePage->attach_file) }}" alt="computer photo" loading="lazy" alt="attach_file" class="img-fluid" style="max-width: 100%; height: auto; border-radius: 10px;"/>
                        </div>
                        <div class="col-lg-6 col-md-6  align-items-stretch mb-3" style="padding:3%;font-family: 'Arial'; font-size: 18px; line-height: 1.6; color: #333;">
...
@if(count($TextBanners)>0)
    ...
    <section id="services" class="services section-bg">
        <div class="" style="background-color: #FFFFFF;padding: 3%;width:100% ">
            <div class="section-title">
                <h2>{{__('frontend.systemUsers')}}</h2>
                <p> {{__('frontend.systemUsersDes')}}</p>
            </div>
