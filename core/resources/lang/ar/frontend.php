...
return [
    ...
    'valednum'=>'ادخل رقم حصرا',
    'Certificate_Details'=>'تفاصيل الشهادة',
    'address' => 'العنوان',
    'nodata'=>'..لا يوجد سجل حاليا ، تأكد من رقم الشهادة أو حاول مجددا في وقت لاحق',
    'Go_Back'=>'رجوع',
    'Certificate_Number'=>'رقم الشهادة:',
    'Holder_Name'=>'اسم صاحب الشهادة',
    'Expiry'=>'تاريخ انتهاء صلاحية الشهادة',
    'Release'=>'تاريخ منح الشهادة',
    'Issuing'=>'الجهة المانحة للشهادة',
    'status'=>'حالة الشهادة',
    'add'=>'حفظ',
    'Expired'=>'منتهية الصلاحية',
    'Not_approved'=>'غير معتمدة',
    'approved'=>'معتمدة',
    'new_certificate'=>'إضافة شهادة جديدة',
    ...
    'Programminglanguage' => 'لغات البرمجة',
    'Programminglanguagedes' => 'هذه بعض اللغات التي استخدمناها في إنشاء هذا الموقع',
    'quickLinks' => 'روابط سريعة',


    // v10.2
    'welcom'=>'اهلا بكم في Crest Board USA',
    'Features' => 'مميزات مؤسستنا',
    'textFeatures' => 'انضمت إلى Crest Board USA وتمتع بالعديد من الميزات ',
    'systemUsers'=>'مستخدموا النظام',
    'systemUsersDes'=>'اتطلع على ما يمكن للمستخدم فعله حسب دوره في النظام',
    'app'=>'آخر نجازاتنا',
    'appDes'=>'سارع بتنزيل التطبيق للحصول على تجربة اكثر تميزاً',
    'whatNew'=>'ما الجديد ؟',
